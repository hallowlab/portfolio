...
import dodoex from "../../assets/images/projects/dodoex.png";
import brewlabs from "../../assets/images/projects/brewlabs.png";
...
export const web = [
  {
    ...
    date: "2022-05-08",
    cover: portfolio,
    links: [{ icon: gitLink, link: "https://github.com/hallowlab/portfolio" }],
  },
  {
    name: "Livrator.ro",
    date: "2022-04-30",
  ...
  },
  {
    ...
    links: [{ icon: gitLink, link: "https://github.com/hallowlab/Top-three-crypto" }],
  },
  {
    name: "Brewlabs",
    date: "2022-05-01",
    cover: brewlabs,
    links: [{ icon: webLink, link: "https://earn.brewlabs.info/" }],
  },
  {
    name: "Dodoex",
    date: "2022-05-01",
    cover: dodoex,
    links: [{ icon: webLink, link: "https://app.dodoex.io/" }],
  },
  {
    name: "Travel Deck",
    date: "2021-11-16",
  ...
  },
  {
    ...
    cover: navui,
    links: [
      { icon: gitLink, link: "https://github.com/hallowlab/Navigation-menu-animation" },
    ],
  },

  {
    ...
    date: "2022-05-01",
    cover: btnanim,
    links: [{ icon: gitLink, link: "https://github.com/hallowlab/Comic-book-button-anim" }],
  },
];
...
export const design = [
  ...
  },
  {
    ...
    date: "2022-06-05",
    cover: discoverro,
    links: [{ icon: ytLink, link: "https://www.youtube.com/watch?v=vzyxaw_ryyQ" }],
  },
  {
    name: "Vice City Conceput UI",
    date: "2022-08-14",
    cover: vclp,
    links: [{ icon: ytLink, link: "https://www.youtube.com/watch?v=ysBkWUQMLHQ" }],
  },
];
